...
- Остальные файлы (исходник сервера на си и Dockerfile и start.sh) не менялись, остались такие же как в прошлых частях
