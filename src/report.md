...
- Вообщем говоря, делаем **то же самое** что и в [Part 3] но через **Dockerfile**
    ...
    - ![](./pics/2024sept_pic40.png)
        - Что за команды?
            - **FROM** указывает из какого образа собирать, можно и **nginx:latest** указать, разницы нетю
            ...
            - **WORKDIR** указывает рабочую папку, место откуда будут запускаться команды из **ENTRYPOINT**
                - соответственно, поэтому и указывается папка /etc/nginx, так как туда и си файл был скопирован. Чтобы потом его скомпилировать и через спавн-фсджиай запустить
...
- Через команду:
    ...
    - Билд в процессе \
    - ![](./pics/2024sept_pic41.png)

    - Сообщение об успехе \
    - ![](./pics/2024sept_pic42.png)

---
##### Проверь через `docker images`, что все собралось корректно.
- Проверяю, всё есть: \
    - ![](./pics/2024sept_pic43.png)
